...
public class ExactlyOnceConsumer {
    ...
    private static String topicName = "exactly-once-demo";

    public static void main(String[] args) {
        Properties prop = new Properties();
        prop.put(ConsumerConfig.CLIENT_ID_CONFIG, "MostOnceConsumer");
        prop.put(ConsumerConfig.GROUP_ID_CONFIG, "MostOnceConsumerGroup");
