...
public class AtLeastOnceConsumer {
    ...
    private static String topicName = "at-least-once-demo";

    public static void main(String[] args) {
        Properties prop = new Properties();
        prop.put(ConsumerConfig.CLIENT_ID_CONFIG, "AtLeastOnceConsumer");
        prop.put(ConsumerConfig.GROUP_ID_CONFIG, "AtLeastOnceConsumerGroup");
        ...
        try (KafkaConsumer<Integer, String> consumer = new KafkaConsumer<>(prop);) {
            ...
            while (true) {
                ...
                if (records.count() > 0) {
                    ...
                    Map<TopicPartition, OffsetAndMetadata> commitInfo = new HashMap<TopicPartition, OffsetAndMetadata>();
