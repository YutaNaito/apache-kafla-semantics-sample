...
public class SampleConsumer {
    ...
    private static String topicName = "sample";

    public static void main(String[] args) {
        Properties prop = new Properties();
        prop.put(ConsumerConfig.CLIENT_ID_CONFIG, "SampleConsumer");
        prop.put(ConsumerConfig.GROUP_ID_CONFIG, "SampleConsumerGroup");
        ...
        prop.put(ConsumerConfig.ISOLATION_LEVEL_CONFIG, "read_uncommitted");
